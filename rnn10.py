...
class MetaRNN(BaseEstimator):
    ...
    def fit(self, X_train, Y_train, X_test=None, Y_test=None,
        ...
        """
        f = file('trainProcess/trainOutput-b10-500-200-10.txt','a+')
...
def test_binary(multiple_out=False, n_epochs=250):
    ...
    file_path1 = os.path.join(BASE_DIR,"traindata/inputdata-b10-500-10.txt")
    ...
    count = 0
    dataTest = []
    file_path2 = os.path.join(BASE_DIR, 'testdata/inputdata-b10-200-10.txt')
...
if __name__ == "__main__":
    ...
    test_binary(multiple_out=True, n_epochs=44)
