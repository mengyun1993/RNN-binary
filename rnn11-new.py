...
def test_binary(multiple_out=False, n_epochs=250):
    ...
    file_path1 = os.path.join(BASE_DIR,"../RNN-data/traindata/inputdata-b11-50-20-30-n.txt")
    ...
    count = 0
    dataTest1 = []
    file_path2 = os.path.join(BASE_DIR, '../RNN-data/testdata/inputdata-b11-200-20.txt')
...
##############  Add another Test  ####################
    ...
    file_path4 = os.path.join(BASE_DIR, '../RNN-data/testdata/inputerror-b11-20-20-25-y.txt')
...
###########  End add another Test  ##############
    ...
    fmatrix = file('../RNN-data/matrix/freqMatrix-b11.txt','a+')
    for i in range (lineNum):
    ...
    ferror1 = file('errorRate/errorRate-b11-no.txt','a+')
    ferror2 = file('errorRate/errorRate-b11-single.txt','a+')
    [seqNum,lineNum,colNum] = targetsTest1.shape
