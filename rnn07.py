...
class MetaRNN(BaseEstimator):
    ...
    def fit(self, X_train, Y_train, X_test=None, Y_test=None,
        ...
        """
        f = file('trainProcess/trainOutput-b07-1000-300-30.txt','a+')
...
def test_binary(multiple_out=False, n_epochs=250):
    ...
    file_path1 = os.path.join(BASE_DIR,"traindata/inputdata-b07-1000-30.txt")
    ...
    count = 0
    dataTest = []
    file_path2 = os.path.join(BASE_DIR, 'testdata/inputdata-b07-300-30.txt')
    ...
    ferror = file('errorRate/errorRate-b07-1000-300-30.txt','a+')
