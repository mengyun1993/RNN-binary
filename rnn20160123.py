            ...
            for idx in xrange(n_train):
                ...
                if iter % validation_frequency == 0:
                    ...
                    if self.interactive:
                        ...
                        logging.info('epoch %i, seq %i/%i, tr loss %f '
                                    'te loss %f lr: %f' % \
                        (epoch, idx + 1, n_train,
                         this_train_loss, this_test_loss, self.learning_rate))
                    else:
                        logging.info('epoch %i, seq %i/%i, train loss %f '
                                    'lr: %f' % \
...
if __name__ == "__main__":
     logging.basicConfig(
                 ...
                 filemode = 'w')
#    fileHandler = logging.FileHandler("D:/logresult20160123/one.log", mode = "w", encoding = "UTF-8")
